 ...
 * - filmRating: пользовательский рейтинг фильма
 * - mpa: объект типа Mpa, который содержит информацию о рейтинге фильма
 * - usersRatedFilm: множество пользователей, которые поставили фильму оценку
 * - genres: множество жанров, к которым относится фильм
 * - directors: множество режиссеров, которые работали над фильмом
 */
@Data
