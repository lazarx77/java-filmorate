...
(
    ...
    USER_ID BIGINT,
    USER_RATING INTEGER,
    CONSTRAINT RATINGS_FILMS_FK FOREIGN KEY (FILM_ID) REFERENCES PUBLIC.FILMS (FILM_ID),
    CONSTRAINT RATINGS_USERS_FK FOREIGN KEY (USER_ID) REFERENCES PUBLIC.USERS (USER_ID)
);
